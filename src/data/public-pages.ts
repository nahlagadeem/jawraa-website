...
export const aboutPage = {
  ...
  timeline: [
    ...
    { year: "2017", label: { en: "Founded with a vision to provide innovative IT solutions.", ar: "تأسست برؤية لتقديم حلول تقنية معلومات مبتكرة." } },
    { year: "2021", label: { en: "Established as a system integrator, offering comprehensive IT services.", ar: "تأسست كمكامل أنظمة، تقدم خدمات تقنية معلومات شاملة." } },
    ...
    { year: "2023", label: { en: "Expanded into telecom in-building solutions, providing cutting-edge connectivity solutions.", ar: "توسعت في حلول الاتصالات داخل المباني، مقدمة حلول اتصال متطورة." } },
    { year: "2024", label: { en: "Became a cloud and managed service provider, offering scalable and reliable cloud-based solutions.", ar: "أصبحت مزودًا للخدمات السحابية والخدمات المُدارة، مقدمة حلولًا سحابية قابلة للتوسع وموثوقة." } },
    { year: "2025", label: { en: "Founded with a vision to provide innovative IT solutions.", ar: "تأسست برؤية لتقديم حلول تقنية معلومات مبتكرة." } },
    { year: "2026", label: { en: "Established as a system integrator, offering comprehensive IT services.", ar: "تأسست كمكامل أنظمة، تقدم خدمات تقنية معلومات شاملة." } },
  ],
...
export const servicePages: Record<string, ServicePageData> = {
  "managed-services": {
    ...
    featureCards: [
      { title: { en: "We accelerate digital transformation with tailored IT services.", ar: "نسرّع التحول الرقمي من خلال خدمات تقنية معلومات مصممة خصيصًا." }, description: { en: "As a trusted leader in managed services, Jawraa delivers cutting-edge solutions that drive digital transformation for government entities, telecom operators, and SMBs. Our team of industry experts applies the skills and knowledge needed to manage multi-technology projects effectively, ensuring on-time delivery, cost efficiency, and high-quality outcomes that accelerate growth in a digital-first world.", ar: "بصفتها رائدة موثوقة في الخدمات المُدارة، تقدم جوراء حلولًا متطورة تدفع التحول الرقمي للجهات الحكومية، ومشغلي الاتصالات، والمنشآت الصغيرة والمتوسطة. يطبّق فريقنا من خبراء الصناعة المهارات والمعرفة اللازمة لإدارة المشاريع متعددة التقنيات بفاعلية، بما يضمن التسليم في الوقت المحدد، وكفاءة التكلفة، ومخرجات عالية الجودة تسرّع النمو في عالم رقمي أولًا." }, image: "/assets/logos/managed-accelerate-digital-transformation.png" },
      { title: { en: "Innovative managed services for digital transformation.", ar: "خدمات مُدارة مبتكرة للتحول الرقمي." }, description: { en: "Jawraa provides comprehensive managed services tailored to unique business needs, drawing on over 20 years of industry expertise. Our proficiency in navigating complex, multi-technology projects guarantees timely delivery and exceptional outcomes. We deliver cost-effective solutions that drive success by prioritizing your business objectives and leveraging our robust partnerships.", ar: "تقدم جوراء خدمات مُدارة شاملة مصممة وفق احتياجات الأعمال الفريدة، مستندة إلى أكثر من 20 عامًا من الخبرة في القطاع. تضمن كفاءتنا في إدارة المشاريع المعقدة متعددة التقنيات التسليم في الوقت المناسب وتحقيق نتائج استثنائية. نقدم حلولًا فعّالة من حيث التكلفة تدفع النجاح من خلال إعطاء الأولوية لأهداف أعمالك والاستفادة من شراكاتنا القوية." }, image: "/assets/logos/managed-innovative-digital-transformation.png" },
      { title: { en: "Strategic IT governance for sustainable success.", ar: "حوكمة استراتيجية لتقنية المعلومات لتحقيق نجاح مستدام." }, description: { en: "Jawraa devotes time to understanding each business model and collaborating closely with stakeholders to assess operations comprehensively. This partnership allows us to craft a digitized business model underpinned by automated processes that enhance operational efficiency. Our strategic approach boosts efficiency, elevates customer satisfaction, and drives stronger return on investment.", ar: "تخصص جوراء الوقت لفهم كل نموذج عمل والتعاون الوثيق مع أصحاب المصلحة لتقييم العمليات بصورة شاملة. تتيح لنا هذه الشراكة صياغة نموذج أعمال رقمي مدعوم بعمليات مؤتمتة تعزز الكفاءة التشغيلية. يعزز نهجنا الاستراتيجي الكفاءة، ويرفع رضا العملاء، ويدفع عائدًا أقوى على الاستثمار." }, image: "/assets/logos/managed-strategic-it-governance.png" },
      { title: { en: "IT talent solutions that catalyze digital transformation.", ar: "حلول مواهب تقنية المعلومات التي تحفّز التحول الرقمي." }, description: { en: "Jawraa offers staffing and HR solutions tailored for businesses and governmental agencies needing highly skilled professionals to drive their digital transformation journey. With a strong outsourcing record and broad certifications across leading IT domains, we ensure swift turnaround times and expedited project delivery.", ar: "تقدم جوراء حلول التوظيف والموارد البشرية المصممة للشركات والجهات الحكومية التي تحتاج إلى متخصصين ذوي مهارات عالية لدفع رحلة التحول الرقمي. ومن خلال سجل قوي في التعهيد وشهادات واسعة عبر مجالات تقنية المعلومات الرائدة، نضمن أوقات إنجاز سريعة وتسليمًا معجلًا للمشاريع." }, image: "/assets/logos/managed-it-talent-solutions.png" },
    ],
    strengths: [
      { title: { en: "Industry Experts", ar: "خبراء الصناعة" }, description: { en: "A highly skilled team managing multi-technology environments.", ar: "فريق عالي المهارة يدير بيئات متعددة التقنيات." }, image: "/assets/logos/managed-industry-experts.svg" },
      { title: { en: "On-Time Delivery", ar: "التسليم في الوقت المحدد" }, description: { en: "Proven project execution aligned with strict timelines.", ar: "تنفيذ مشاريع مثبت ومتوافق مع جداول زمنية صارمة." }, image: "/assets/logos/managed-on-time-delivery.svg" },
      { title: { en: "Cost Efficiency", ar: "كفاءة التكلفة" }, description: { en: "Optimized solutions that reduce operational costs.", ar: "حلول محسّنة تقلل التكاليف التشغيلية." }, image: "/assets/logos/managed-cost-efficiency.svg" },
      { title: { en: "High-Quality Outcomes", ar: "مخرجات عالية الجودة" }, description: { en: "Reliable implementation aligned with global standards.", ar: "تنفيذ موثوق متوافق مع المعايير العالمية." }, image: "/assets/logos/managed-high-quality-outcomes.svg" },
    ],
    outcomeCards: [
      { title: { en: "Business Digitization", ar: "التحول الرقمي للأعمال" }, description: { en: "Automated processes that optimize operations.", ar: "عمليات مؤتمتة تُحسّن التشغيل." }, image: "/assets/logos/managed-business-digitization.svg" },
      { title: { en: "Operational Excellence", ar: "التميز التشغيلي" }, description: { en: "Improved efficiency through strategic IT governance.", ar: "كفاءة محسّنة من خلال حوكمة استراتيجية لتقنية المعلومات." }, image: "/assets/logos/managed-operational-excellence.svg" },
      { title: { en: "Stakeholder Alignment", ar: "مواءمة أصحاب المصلحة" }, description: { en: "Collaborative planning that ensures unified objectives.", ar: "تخطيط تعاوني يضمن توحيد الأهداف." }, image: "/assets/logos/managed-stakeholder-alignment.svg" },
      { title: { en: "Accelerated Delivery", ar: "تسليم متسارع" }, description: { en: "Swift deployment supported by certified IT professionals.", ar: "تنفيذ سريع مدعوم بمحترفي تقنية معلومات معتمدين." }, image: "/assets/logos/managed-accelerated-delivery.svg" },
    ],
    includedTitle: { en: "Our Managed Services Include", ar: "تشمل خدماتنا المُدارة" },
    included: [
      { title: { en: "IT as a Service", ar: "تقنية المعلومات كخدمة" }, description: { en: "Flexible IT solutions delivered on demand to support evolving business needs.", ar: "حلول تقنية معلومات مرنة تُقدّم عند الطلب لدعم احتياجات الأعمال المتغيرة." }, image: "/assets/logos/managed-it-as-a-service.svg" },
      { title: { en: "Outsourcing Services", ar: "خدمات استقطاب وإسناد الكفاءات (Outsourcing)" }, description: { en: "Flexible IT professionals and sourcing solutions delivered on demand to support evolving business needs.", ar: "نوفر كوادر تقنية مؤهلة وحلول استقطاب مرنة عند الطلب، لمساعدة المؤسسات على مواكبة متطلبات الأعمال المتجددة." }, image: "/assets/logos/managed-outsourcing-services.svg" },
      { title: { en: "Project Management", ar: "إدارة المشاريع" }, description: { en: "Structured project governance ensuring timely and cost-effective delivery.", ar: "حوكمة مشاريع منظمة تضمن التسليم في الوقت المناسب وبكفاءة من حيث التكلفة." }, image: "/assets/logos/managed-project-management.svg" },
      { title: { en: "System Implementation", ar: "تنفيذ الأنظمة" }, description: { en: "End-to-end system deployment aligned with strategic objectives.", ar: "نشر الأنظمة من البداية إلى النهاية بما يتماشى مع الأهداف الاستراتيجية." }, image: "/assets/logos/managed-system-implementation.svg" },
      { title: { en: "Strategy", ar: "الاستراتيجية" }, description: { en: "Strategic advisory services to align technology with business vision.", ar: "خدمات استشارية استراتيجية لمواءمة التقنية مع رؤية الأعمال." }, image: "/assets/logos/managed-strategy.svg" },
      { title: { en: "Due Diligence", ar: "العناية الواجبة" }, description: { en: "Comprehensive technical and operational assessments for informed decisions.", ar: "تقييمات تقنية وتشغيلية شاملة لاتخاذ قرارات مستنيرة." }, image: "/assets/logos/managed-due-diligence.svg" },
      { title: { en: "Government Stakeholder Management", ar: "إدارة أصحاب المصلحة الحكوميين" }, description: { en: "Structured engagement and coordination with governmental entities.", ar: "تواصل وتنسيق منظم مع الجهات الحكومية." }, image: "/assets/logos/managed-government-stakeholder-management.svg" },
      { title: { en: "Local Supply Cluster Development", ar: "تطوير تجمع الإمداد المحلي" }, description: { en: "Strengthening local ecosystems to enhance sustainable value creation.", ar: "تعزيز المنظومات المحلية لرفع خلق القيمة المستدامة." }, image: "/assets/logos/managed-local-supply-cluster-development.svg" },
      { title: { en: "Organization Design & Procurement", ar: "تصميم المنظمة والمشتريات" }, description: { en: "Optimized organizational structures and procurement strategies.", ar: "هياكل تنظيمية واستراتيجيات مشتريات محسّنة." }, image: "/assets/logos/managed-organization-design-procurement.svg" },
      { title: { en: "Socioeconomic Impact Assessment", ar: "تقييم الأثر الاجتماعي والاقتصادي" }, description: { en: "Data-driven evaluation of long-term social and economic outcomes.", ar: "تقييم قائم على البيانات للنتائج الاجتماعية والاقتصادية طويلة المدى." }, image: "/assets/logos/managed-socioeconomic-impact-assessment.svg" },
    ],
  },
  infrastructure: {
    slug: "infrastructure",
    ...
    introCards: [
      {
        ...
        image: "/assets/logos/infra-build-robust-technology.svg",
      },
      {
        title: { en: "Protect What Matters Most", ar: "حماية ما هو الأهم" },
        description: {
          en: "People, Property, and Processes. Jawraas comprehensive security solutions protect assets, manage access, and optimize building operations.",
          ar: "الأشخاص، والممتلكات، والعمليات. تحمي حلول جوراء الأمنية الشاملة الأصول، وتدير الوصول، وتحسّن كفاءة تشغيل المباني.",
        },
        image: "/assets/logos/infra-protect-what-matters-most.svg",
      },
    ],
    featureCards: [
      { title: { en: "Build, Operate, and Maintain Enduring Data Centers", ar: "بناء وتشغيل وصيانة مراكز بيانات مستدامة" }, description: { en: "Jawraa delivers world-class data center solutions meeting the highest standards of reliability, security, and efficiency.", ar: "تقدم جوراء حلول مراكز بيانات عالمية المستوى تلبي أعلى معايير الموثوقية والأمن والكفاءة." }, image: "/assets/logos/infra-build-operate-data-centers.svg" },
      { title: { en: "Optimize Operational Efficiency and Decision-Making", ar: "تحسين الكفاءة التشغيلية وصنع القرار" }, description: { en: "Jawraa designs state-of-the-art control rooms equipped with advanced technology and ergonomic layouts.", ar: "تصمم جوراء غرف تحكم متطورة مجهزة بتقنيات متقدمة وتخطيطات مريحة." }, image: "/assets/logos/infra-optimize-operational-efficiency.svg" },
      { title: { en: "Simplify Data and Secure Storage", ar: "تبسيط البيانات وتأمين التخزين" }, description: { en: "Jawraa safeguards your critical data with reliable, scalable storage solutions.", ar: "تحمي جوراء بياناتك الحيوية من خلال حلول تخزين موثوقة وقابلة للتوسع." }, image: "/assets/logos/infra-simplify-data-secure-storage.svg" },
      { title: { en: "Customize Network Solutions for Optimal Performance", ar: "تخصيص حلول الشبكات لتحقيق الأداء الأمثل" }, description: { en: "Jawraa designs hardware and network infrastructure solutions tailored to business needs, with a permanent emphasis on security.", ar: "تصمم جوراء حلول الأجهزة والبنية التحتية للشبكات المصممة وفقًا لاحتياجات الأعمال، مع تركيز دائم على الأمن." }, image: "/assets/logos/infra-customize-network-solutions.svg" },
      { title: { en: "Transform Meeting Rooms into Dynamic and Inspiring Environments", ar: "تحويل غرف الاجتماعات إلى بيئات ديناميكية وملهمة" }, description: { en: "Jawraas solutions enable seamless communication and productive collaboration for both in-office and remote teams.", ar: "تتيح حلول جوراء تواصلًا سلسًا وتعاونًا منتجًا لكل من فرق العمل داخل المكتب وعن بُعد." }, image: "/assets/logos/infra-transform-meeting-rooms.svg" },
      { title: { en: "Foster Engagement and Drive Business Success", ar: "تعزيز التفاعل ودفع نجاح الأعمال" }, description: { en: "Jawraas enterprise-grade digital signage solutions elevate workplace communication and employee engagement.", ar: "ترتقي حلول اللافتات الرقمية المؤسسية من جوراء بتواصل بيئة العمل وتفاعل الموظفين." }, image: "/assets/logos/infra-foster-engagement.svg" },
    ],
    includedTitle: {
  ...
  "systems-cloud": {
    ...
    introCards: [
      {
        ...
        image: "/assets/logos/cloud-we-empower-our-clients.svg",
      },
    ],
    overviewEyebrow: {
    ...
    featureCards: [
      { title: { en: "Unlock the Power of the Cloud", ar: "استثمر القوة الكاملة للحوسبة السحابية" }, description: { en: "Jawraa plays a pivotal role in enabling its clients to leverage the cloud's benefits by maximizing efficiency and minimizing costs Whether moving systems to the cloud or optimizing existing solutions, our experts assess, evaluate, and choose the optimal solution.", ar: "تلعب جوراء دورًا محوريًا في تمكين عملائها من الاستفادة من مزايا السحابة عبر تعظيم الكفاءة وتقليل التكاليف. سواءً بنقل الأنظمة إلى السحابة أو تحسين الحلول الحالية، فإن خبراءنا يقيّمون ويحلّلون ويختارون الحل الأمثل." }, image: "/assets/logos/cloud-unlock-power.svg" },
      { title: { en: "Drive business value and optimize operations", ar: "عزّز قيمة الأعمال وحسّن العمليات" }, description: { en: "Jawraa delivers comprehensive software implementation and integration services focused on efficiency and effectiveness our experts assist in selecting the right software solutions, customizing them, and integrating them with existing systems.", ar: "تقدّم جوراء خدمات شاملة لتنفيذ البرمجيات وتكاملها تركّز على الكفاءة والفعالية، ويساعد خبراؤنا في اختيار الحلول البرمجية المناسبة، وتخصيصها، ودمجها مع الأنظمة الحالية." }, image: "/assets/logos/cloud-drive-business-value.svg" },
      { title: { en: "Prioritize security, accessibility, and integrity of data.", ar: "إعطاء الأولوية لأمن البيانات وإمكانية الوصول إليها وسلامتها." }, description: { en: "Jawraa safeguards critical data with robust data management and backup solutions our experts ensure data security, accessibility, and business continuity through strategic planning and advanced technologies.", ar: "تحمي جوراء البيانات الحيوية من خلال حلول قوية لإدارة البيانات والنسخ الاحتياطي، ويضمن خبراؤنا أمن البيانات، وإمكانية الوصول إليها، واستمرارية الأعمال عبر التخطيط الاستراتيجي والتقنيات المتقدمة." }, image: "/assets/logos/cloud-prioritize-security.svg" },
      { title: { en: "Scale business operations.", ar: "وسّع نطاق عمليات الأعمال." }, description: { en: "Jawraa offers expert ERP implementation, customization, and support services tailored to business needs our experts analyze existing processes, help select the right ERP system, configure it, and provide ongoing maintenance.", ar: "تقدّم جوراء خدمات متخصصة في تنفيذ أنظمة ERP وتخصيصها ودعمها بما يتناسب مع احتياجات الأعمال. ويحلل خبراؤنا العمليات الحالية، ويساعدون في اختيار نظام ERP المناسب، وتهيئته، وتقديم الصيانة المستمرة." }, image: "/assets/logos/cloud-scale-business-operations.svg" },
    ],
    includedTitle: { en: "Systems & Cloud Services Include:", ar: "تشمل خدمات الأنظمة والسحابة:" },
    included: [
      { title: { en: "Systems and Applications", ar: "الأنظمة والتطبيقات" }, description: { en: "", ar: "" }, image: "/assets/logos/cloud-systems-and-applications.svg" },
      { title: { en: "Business Intelligence", ar: "ذكاء الأعمال" }, description: { en: "", ar: "" }, image: "/assets/logos/cloud-business-intelligence.svg" },
      { title: { en: "IaaS, PaaS, SaaS", ar: "IaaS, PaaS, SaaS" }, description: { en: "", ar: "" }, image: "/assets/logos/cloud-iaas-paas-saas.svg" },
      { title: { en: "ERP", ar: "ERP" }, description: { en: "", ar: "" }, image: "/assets/logos/cloud-erp.svg" },
      { title: { en: "Workflow", ar: "سير العمل" }, description: { en: "", ar: "" }, image: "/assets/logos/cloud-workflow.svg" },
      { title: { en: "Site co-location", ar: "الاستضافة المشتركة للموقع" }, description: { en: "", ar: "" }, image: "/assets/logos/cloud-site-co-location.svg" },
      { title: { en: "EPM Dashboard", ar: "لوحة معلومات EPM" }, description: { en: "", ar: "" }, image: "/assets/logos/cloud-epm-dashboard.svg" },
      { title: { en: "DR solution", ar: "حل DR" }, description: { en: "", ar: "" }, image: "/assets/logos/cloud-dr-solution.svg" },
      { title: { en: "Azure Pack", ar: "حزمة Azure" }, description: { en: "", ar: "" }, image: "/assets/logos/cloud-azure-pack.svg" },
    ],
  },
  cybersecurity: {
    slug: "cybersecurity",
